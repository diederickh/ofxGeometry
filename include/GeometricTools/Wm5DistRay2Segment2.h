...
#ifndef WM5DISTRAY2SEGMENT2_H
#define WM5DISTRAY2SEGMENT2_H
...
class WM5_MATHEMATICS_ITEM DistRay2Segment2
    : public Distance<Real,Vector2<Real> >
{
public:
    DistRay2Segment2 (const Ray2<Real>& ray, const Segment2<Real>& segment);
