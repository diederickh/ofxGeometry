...
#ifndef WM5LIGHTSPOTCONSTANT_H
#define WM5LIGHTSPOTCONSTANT_H
...
class WM5_GRAPHICS_ITEM LightSpotConstant : public ShaderFloat
{
    WM5_DECLARE_RTTI;
    WM5_DECLARE_NAMES;
    WM5_DECLARE_STREAM(LightSpotConstant);
...
WM5_REGISTER_STREAM(LightSpotConstant);
